...
Public Type uSteelArea
    lpRect              As RECT2
End Type

Public Type uLevelData
    Title               As String * 32   '  1
    LemsToLetOut        As Byte          ' 33
    ReleaseRate         As Byte          ' 34
    LemsToBeSaved       As Byte          ' 35
...
Public uLEVEL           As uLevelData
Public uOBJGFX()        As uuOBJGFX
Public uTERGFX()        As uuTERGFX

...
Public Sub InitializeMusic()
    ...
    m_hWnd = fMain.hWnd
    m_lpPrevWndProc = SetWindowLong(m_hWnd, GWL_WNDPROC, AddressOf wgMidiNotify)
End Sub
...
Private Function wgMidiNotify( _
    ...
    wgMidiNotify = CallWindowProc(m_lpPrevWndProc, hWnd, uMsg, wParam, lParam)
End Function

...
Public Sub MaskBlt( _
  ...
  Dim j As Long, i2 As Long, j2 As Long, k2 As Long, r2 As Long
    ...
    If (wgCheckDIBDIBRects( _
        ...
        Call wgMapDIB(uDstSA, lDstBits(), oDstDIB)
        Call wgMapDIB(uSrcSA, lSrcBits(), oSrcDIB)
        ...
        Call wgUnmapDIB(lDstBits())
        Call wgUnmapDIB(lSrcBits())
    End If
End Sub
...
Private Sub wgMapDIB(uSA As SAFEARRAY1D, lBits() As Long, oDIB As cDIB32)
...
Private Sub wgUnmapDIB(lBits() As Long)

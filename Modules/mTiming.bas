...
Public Sub StartTimer()
  ...
  Dim t As Long
    ...
    If (m_bTimerActivated = False) Then
        ...
        Do
            '-- Frame dt
            If (timeGetTime() - t >= TMR_DT_FRAME) Then '*
                t = timeGetTime()
                Call wgTimerTick
            End If
...
Public Sub StartArmageddon()
    ...
    '-- Activate Armageddon
    If (GetGameStage = [gsPlaying]) Then
...
Private Sub wgTimerTick()
    ...
    If (m_bTimerPaused = False) Then
        ...
        Do ' Fast-forward!
            ...
            '-- Can release?
            If (GetGameStage = [gsPlaying] And m_bArmageddonActivated = False) Then
            ...
            If (GetGameStage() = [gsPlaying]) Then
                ...
                If (m_lcTimer = TMR_TIMESEC) Then
                    ...
                    '-- Show time
                    fMain.ucInfo.Panels(5) = GetMinSecString(g_lcPlayingTime)
        ...
        Call VBA.DoEvents
        Loop Until (GetAsyncKeyState(vbKeyF) = 0 Or _

...
Begin VB.Form fEdit 
   ...
   Caption         =   "WinLems Level Editor - [No level]"
   ClientHeight    =   8175
   ClientLeft      =   4215
   ClientTop       =   2355
   ClientWidth     =   9600
   ...
   Begin VB.CheckBox chkUpsideDown 
      ...
      Width           =   1425
   End
   Begin WinLemsEdit.ucScreen32 ucScreen 
      Height          =   4800
      Left            =   0
      TabIndex        =   0
      TabStop         =   0   'False
   ...
   Begin VB.Frame fraOptions 
      ...
      Visible         =   0   'False
      Width           =   6450
      Begin WinLemsEdit.ucScreen32 ucObjectPreview 
         Height          =   2490
         Left            =   1980
         TabIndex        =   30
         TabStop         =   0   'False
   ...
   Begin VB.Frame fraOptions 
      ...
      Visible         =   0   'False
      Width           =   6495
      Begin WinLemsEdit.ucScreen32 ucTerrainPiecePreview 
         Height          =   2490
         Left            =   1980
         TabIndex        =   39
         TabStop         =   0   'False
   ...
   Begin VB.Frame fraOptions 
      ...
      Begin VB.CheckBox chkShowTriggerAreas 
         ...
         Width           =   1980
      End
      Begin VB.CheckBox chkRedBlackPieces 
         Caption         =   "Red black-pieces"
         Height          =   255
         Left            =   2370
         TabIndex        =   61
         Top             =   1470
         Width           =   1980
      End
      Begin VB.CheckBox chkEnhanceSelected 
         Caption         =   "Enhance selected"
         Height          =   255
         Left            =   165
         TabIndex        =   56
         Top             =   1470
         ...
         Width           =   1980
      End
      Begin WinLemsEdit.ucProgress ucPrgObjects 
         Height          =   315
         Left            =   1095
         Top             =   2175
         Width           =   1590
      ...
      Begin VB.OptionButton optSelectionPreference 
         ...
         Width           =   1875
      End
      Begin WinLemsEdit.ucProgress ucPrgTerrainPieces 
         Height          =   315
         Left            =   2880
         Top             =   2175
         Width           =   1590
         ...
         ForeColor       =   0
      End
      Begin WinLemsEdit.ucProgress ucPrgSteelAreas 
         Height          =   315
         Left            =   4680
         Top             =   2175
         Width           =   1590
...
'================================================
' Project:       WinLems Level Editor - 1.0.0
...
Private Sub Form_Load()
    ...
    '-- Style changes
    Call mMisc.RemoveButtonBorderEnhance(cmdObjectAdd)
    Call mMisc.RemoveButtonBorderEnhance(cmdTerrainPieceAdd)
    Call mMisc.RemoveButtonBorderEnhance(cmdSteelAreaAdd)
    Call mMisc.RemoveButtonBorderEnhance(cmdUp)
    Call mMisc.RemoveButtonBorderEnhance(cmdDown)
    Call mMisc.RemoveButtonBorderEnhance(cmdLeft)
    Call mMisc.RemoveButtonBorderEnhance(cmdRight)
    Call mMisc.RemoveButtonBorderEnhance(cmdZOrderUp)
    Call mMisc.RemoveButtonBorderEnhance(cmdZOrderDown)
    
    '-- Initialize game screen
    With ucScreen
        .EraseBackground = False
        .WorkMode = [cnvUserMode]
        .Zoom = 2
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
  ...
  Dim lRet As VBA.VbMsgBoxResult
    ...
    '-- Ask for saving
    lRet = VBA.MsgBox( _
           "Save level before closing?", _
           vbInformation Or vbYesNoCancel Or vbDefaultButton2 _
           )
...
Private Sub mnuHelp_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0 '-- About
            ...
            Call MsgBox("WinLems Level Editor " & App.Major & "." & App.Minor & Space(10) & vbCrLf & vbCrLf & _
                        "Created by Warren Galyen" & vbCrLf & vbCrLf & _
                        "© Wildfire Software Design 2005-2007", _
                        vbInformation _
                        )
    End Select
End Sub
...
Private Sub chkEnhanceSelected_Click()
    mEdit.EnhanceSelected = CBool(chkEnhanceSelected)
End Sub

Private Sub chkRedBlackPieces_Click()
    mEdit.RedBlackPieces = CBool(chkRedBlackPieces)
End Sub
...
Private Sub wgInitializeGraphicSet()
...
Private Sub wgUpdateAppCaption()
    
    Me.Caption = "WinLems Level Editor - ["
